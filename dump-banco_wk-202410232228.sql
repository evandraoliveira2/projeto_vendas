...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `FK_CLIENTES` FOREIGN KEY (`CODIGO_CLIENTE`) REFERENCES `clientes` (`CODIGO`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pedidos` VALUES (1,'2024-10-23 20:34:05',4,80.6),(2,'2024-10-23 20:34:05',5,74.6),(3,'2024-10-23 20:34:05',8,88),(4,'2024-10-23 20:34:05',5,74.6),(5,'2024-10-23 20:34:05',5,150.6),(6,'2024-10-23 20:34:05',4,184.7),(15,'1899-12-30 20:34:05',6,135);
...
CREATE TABLE `pedidos_produtos` (
  ...
  CONSTRAINT `FK_PEDIDOS_PRODUTOS` FOREIGN KEY (`NUMERO_PEDIDO`) REFERENCES `pedidos` (`NUMERO`),
...
INSERT INTO `pedidos_produtos` VALUES (3,2,5,2,19,38),(4,2,7,2,18.3,36.6),(5,3,10,4,15,60),(6,3,11,2,14,28),(9,5,5,4,19,76),(10,5,7,2,18.3,36.6),(40,4,5,2,19,38),(41,4,7,2,18.3,36.6),(43,1,7,2,18.3,36.6),(44,1,4,2,22,44),(51,6,4,4,22,88),(52,6,6,2,16.4,32.8),(53,6,8,1,19.9,19.9),(54,15,10,9,15,135);
...
-- Dump completed on 2024-10-23 22:28:57
